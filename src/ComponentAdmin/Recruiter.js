...
function Recruiter() {
  const [recruiterPersona, setRecruiterPersona] = useState(false);
  const [suspendPersona, setSuspendPersona] = useState(false);
  const [userInformation, setUserInfromation] = useState({});
  const [dataPresent, setDataPresent] = useState(false);

  function handleRecruiterPersona() {
    setRecruiterPersona(true);
  }
  // function handleSuspendPersona() {
  //   setSuspendPersona(true);
  // }
  function handleOutClick() {
    setRecruiterPersona(false);
    setSuspendPersona(false);
  }
  useEffect(() => {
    fetch(`http://nubeero-deployment-server.uksouth.cloudapp.azure.com:9009/api/Eclat/company/getAll`)
    ...
    <>
      <div className="bg-[#fff] w-[100%] h-[150vh] ">
        ...
        <div className=" ml-[18rem] pt-[30px] ">
          <h1 className=" text-[#38761D] text-[30px] font-[300px] ">Recruiter</h1>
          <div className="flex justify-between w-[950px] mt-[25px] ml-1 mr-[30px] 6xl:w-[1300px] 5xl:w-[2000px] 4xl:w-[1500px] ">
            <div className=" w-[300px] 4xl:w-[450px] 5xl:w-[500px] h-[120px] rounded-[5px] border-[#E3E7EB] border-[1px]  ">
              <div className="flex ml-[20px] mt-[35px]  justify-between items-center w-[200px]">
                ...
                <div>
                  <h3 className=" text-[14px] text-[#38761D] font-[300px] opacity-70 ">Total Recruiters</h3>
            ...
            <div className=" w-[300px] 4xl:w-[450px] 5xl:w-[500px] h-[120px] rounded-[5px] border-[#E3E7EB] border-[1px] ">
              <div className="flex ml-[20px] mt-[35px]  justify-between items-center w-[235px]">
                ...
                <div>
                  <h3 className=" text-[14px] text-[#38761D] font-[300px] opacity-70 ">Unverified Recruiters</h3>
          ...
          <div className="w-[950px] ml-1 mt-[19px] h-[575px]  rounded-[5px] border-[#E3E7EB] border-[1px] 5xl:w-[2000px] 6xl:w-[1300px] 4xl:w-[1500px]">
            <div className="w-[920px] flex justify-between ml-[20px] mt-[19px] h-[60px]  rounded-[5px] bg-[#F4F4F6] 5xl:w-[1950px] 6xl:w-[1250px] 4xl:w-[1450px]">
              <div className="w-[650px] pl-3 h-[40px] bg-[#fff] justify-between rounded-[4px] ml-[10px] mt-[10px] flex items-center border-[#E3E7EB] border-[1px] 6xl:w-[1000px] 5xl:w-[1650px] 4xl:w-[1150px]">
                ...
                <input
                  ...
                  type="text"
                  placeholder="Search for recruiter, skills, job role etc..."
                />
              </div>
              <div>
            ...
            <table className="w-[920px] ml-[17px] mt-[30px] text-center h-[450px] 5xl:w-[1950px] 4xl:w-[1450px] 6xl:w-[1250px]">
              <thead className="text-[15px] pb-[10px] opacity-90 font-[400px] text-[#38761D]">
                <tr className=" border-b-[#E3E7EB] border-b-[1px] ">
                  ...
                  <th className="pb-[10px]">Industry</th>
                  <th className="pb-[10px]">Company Size</th>
              ...
              <tbody className="text-[13px] w-[920px] opacity-90 font-[400px] text-[#38761D]">
                {dataPresent === false ? (
                  ...
                  visibleData.map((userInfo, index) => (
                    <tr key={index}>
                      ...
                      <td>{userInfo.companyIndustry}</td>
                      <td>{userInfo.companySize}</td>
                      <td>{userInfo.email}</td>
                      <td>Nigeria</td>
                      <td className="pl-[20px]" onClick={handleRecruiterPersona}>
                ...
                {/* <tr className="h-[50px]  ">
                  ...
                  <td>Nigeria </td>
                  <td onClick={handleRecruiterPersona} className=" cursor-pointer pl-[20px]">
                ...
                <tr className="h-[50px]    bg-[#F9F9FA]">
                  ...
                  <td onClick={handleSuspendPersona} className=" cursor-pointer pl-[20px]">
                    <svg width="22" height="4" viewBox="0 0 22 4" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <circle cx="2" cy="2" r="2" fill="#38761D" />
                      <circle cx="11" cy="2" r="2" fill="#38761D" />
                      <circle cx="20" cy="2" r="2" fill="#38761D" />
      ...
      {recruiterPersona && (
        <div className="w-[100%]  h-[150vh] fixed bg-[rgb(0,0,0,0.4)] top-0 left-0 z-0 ">
          ...
          <div className="bg-[#fff] overflow-y-scroll w-[600px] h-[580px] rounded-[10px] ml-[25%] mt-[1%] ">
            <div className=" flex h-[1031px] ">
              <div className="bg-[#F6F8FA] w-[186px] h-[1031px]">
              ...
              <div className="w-[410px]">
                ...
                <div className="mt-[22px] ml-[15px]">
                  <h3 className="text-[16px] text-[#38761D] opacity-[54%] mb-[5px] font-[400]">Company Name</h3>
                  <h4 className="text-[16px] text-[#38761D] font-[400]">Univaciti Limited</h4>
                </div>
                <div className="mt-[18px] ml-[15px]">
                  <h3 className="text-[16px] text-[#38761D] mb-[5px] opacity-[54%] font-[400]">Company Industry</h3>
                  <h4 className="text-[16px] text-[#38761D]  font-[400]">Educational Sector</h4>
                </div>
                <div className="mt-[18px] ml-[15px]">
                  <h3 className="text-[16px] text-[#38761D] mb-[5px] opacity-[54%] font-[400]">Company Size</h3>
                  <h4 className="text-[16px] text-[#38761D]  font-[400]">10 - 20</h4>
                </div>
                <div className="mt-[18px] ml-[15px]">
                  <h3 className="text-[16px] text-[#38761D] mb-[5px] opacity-[54%] font-[400]">Company Website</h3>
                  <h4 className="text-[16px] text-[#38761D]  font-[400]">https://www.amara.com</h4>
                </div>
                <div className="mt-[18px] ml-[15px]">
                  <h3 className="text-[16px] text-[#38761D] mb-[5px] opacity-[54%] font-[400]">Linkedin</h3>
                  <h4 className="text-[16px] text-[#38761D]  font-[400]">https://www.linkedin.com/amara</h4>
                </div>
                <div className="mt-[18px] ml-[15px]">
                  <h3 className="text-[16px] text-[#38761D]  mb-[5px] opacity-[54%] font-[400]">About Company</h3>
                  <h4 className="text-[16px] text-[#38761D] w-[350px] font-[400]">
