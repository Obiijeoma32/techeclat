...
function PageForTalentRequest3() {
      ...
      <div className="w-[100%] xl:w-[100%] bg-[#fff] h-[220vh]">
        ...
        <div className="  flex ml-[80px] pt-[101px]">
          ...
          <div className="flex ml-[12rem] 5xl:w-[1500px] 5xl:justify-evenly 4xl:w-[1700px] 4xl:justify-between">
            <div className=" ml-[10px] w-[600px] mr-[50px] 5xl:w-[950px] 4xl:w-[1000px]">
              <h2 className=" text-[30px] font-[400] mb-[12px] text-[#1E2757] w-[388px] 4xl:w-[600px] 5xl:w-[600px] ">Tell us what talents you are looking for</h2>
              <form className="mt-[54px]">
                ...
                <br />
                <input
                  className=" mb-[20px] mt-[11px] outline-none rounded-[4px] text-[12px]  text-[#667085] pl-[18px] w-[471px] h-[50px] border-[1px] border-[#D0D5DD] 5xl:w-[950px] 4xl:w-[1000px]"
                  type="text"
                  placeholder="Enter role you are looking to hire"
                />
                <br />
                <label htmlFor="talent" className="  text-[16px] w-[210px]  font-[300] mb-[11px] text-[#1E2757] ">
                ...
                <br />
                <label htmlFor="talent" className="  text-[16px] w-[210px]  font-[300] mb-[11px] text-[#1E2757] ">
                  Select the number of resources you require
                </label>
                <br />
                <input
                  className="mb-[20px] mt-[11px] outline-none rounded-[4px] text-[12px]  text-[#667085] pl-[18px] w-[471px] h-[50px] border-[1px] border-[#D0D5DD] 5xl:w-[950px] 4xl:w-[1000px]"
                ...
                />
                <br />
                <label htmlFor="talent" className="  text-[16px] w-[210px]  font-[400] mb-[11px] text-[#1E2757] ">
                  What level of experience are you looking for ?
                </label>
                <div className=" mt-[21px]  flex justify-between w-[270px]">
                  <input name="select" className=" mt-[3px] bg-transparent w-[15px] h-[15px] border-[#DCDDE5] border-[1px]" type="radio" />{" "}
                  <label htmlFor="talent" className="  text-[16px] w-[210px]  font-[300] mb-[11px] text-[#1E2757] ">
                    Entry <br />
                    <span className=" whitespace-nowrap mt-[5px]  text-[14px]  text-[#667085] ">Someone relatively new to this field</span>
                  </label>
                </div>
                <div className=" mt-[10px] flex justify-between w-[360px]">
                  <input name="select" className="mt-[3px] bg-transparent w-[15px] h-[15px] border-[#DCDDE5] border-[1px]" type="radio" />{" "}
                  <label htmlFor="talent" className="  text-[16px] w-[300px]  font-[300] mb-[11px] text-[#1E2757] ">
                    Intermediate
                    <br />
                    <span className=" mt-[5px] w-[270px]  text-[14px]  text-[#667085] ">Someone with a substansial experience in this field</span>
                  </label>
                </div>
                <div className=" mt-[10px] flex justify-between w-[360px]">
                  <input name="select" className="mt-[3px] bg-transparent w-[15px] h-[15px] border-[#DCDDE5] border-[1px]" type="radio" />{" "}
                  <label htmlFor="talent" className="  text-[16px] w-[300px]  font-[300] mb-[11px] text-[#1E2757] ">
                    Expert
                    <br />
                    <span className=" mt-[5px] w-[270px]  text-[14px]  text-[#667085] ">Someone with comprehensive and deep expertise in this field </span>
                  </label>
                </div>
              </form>
              <Link className="" to="">
                <div className="w-[471px] mt-[50px] h-[50px] pt-[12px] rounded-[4px] text-[16px]  text-[#fff] font-[400] text-center bg-[#38761D] ">See Talents</div>
              </Link>
            </div>
            <div className="w-[300px] mt-[-30px] mr-[30px]">
              ...
              <div className="bg-[#ECF2E9] pt-[20px] pl-[18px] h-[340px] mt-[21px] rounded-[20px]">
                <svg width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <circle cx="22.5" cy="22.5" r="22.5" fill="#38761D" fillOpacity="0.2" />
                </svg>
...
export default PageForTalentRequest3;
