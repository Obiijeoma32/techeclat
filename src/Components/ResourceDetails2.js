...
function ResourceDetails2() {
  ...
  const handleSign3Click = async () => {
    ...
    fetch(
      `http://172.160.249.253:9009/api/Eclat/user/${userId}/signUp3`,
      requestOptions
    )
    ...
    <>
      ...
      <div className=" h-[200vh] flex 5xl:mt-[-5%] 3xxl:mt-[10%] 820xxl:mt-[0px] 5xl:ml-[5%]">
        ...
        <div className=" mt-[12%] 4xl:ml-[24rem] 820xxl:ml-[16rem] 5xl:ml-[25rem]  3xxl:ml-[1rem] 1xl:ml-[22rem] ml-[25rem]">
          <h1 className=" 3xxl:w-[300px] 820xxl:w-[471px] text-[#38761D] text-[30px] font-[600] opacity-80 ">
          ...
          <form className="mt-7" action="">
            ...
            <Select
              ...
              value={employmentStatus.find(
                (option) => option.value === employmentStat
              )}
            ...
            <div className=" flex justify-between items-center w-[185px]">
              <input
                className=" rounded-[2px] w-[20px] h-[20px] file:border-[1px] border-[#0098DA] accent-transparent "
                type="checkbox"
              />
              <label
                className=" text-[14px] text-[#192850]"
                htmlFor="currently working here"
              >
            ...
            <br />
            <label
              className="3xxl:w-[150px] text-[16px] text-[#1E2757]"
              htmlFor="role"
            >
